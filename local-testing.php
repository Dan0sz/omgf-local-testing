...
/**
 * Adds an overly complicated stylesheet, generated by Divi, which included TTF and WOFF files, while woff2 is still there. Weird...
 *
 * @return void
 */
function add_crazy_divi_stylesheet() {
	$stylesheet = file_get_contents( LOCAL_TESTING_PLUGIN_DIR . 'assets/css/crazy-divi-stylesheet.css' );
...
add_action( 'wp_head', 'add_crazy_divi_stylesheet' );
